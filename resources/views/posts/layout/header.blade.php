...
<body class="px-12 m-auto">
    <header class="py-6 flex gap-12 items-center justify-between border-b border-gray-500">
        <h1 class="text-5xl select-none">Blog<span class="font-bold">Post</span></h1>
        <nav>
            <ul class="flex items-center gap-6">
                <li><a class="hover:text-blue-500" href="/">Posts</a></li>
        ...
        <div class="flex items-center gap-6">
            <form action="#" method="get">
                ...
                <input type="search" value="{{ request('search') }}" name="search" id="search"
                    ...
                    class="outline-none border-2 focus:border-blue-500  border-gray-300 py-2 px-6 rounded-full">
            </form>
            ...
            <div class="relative" x-data="{ open: false }">
                <button x-on:click="open = ! open">
                    ...
                    @endphp
                    <img src="{{ $image }}" alt="" class="w-14 h-14 rounded-full object-cover">
                ...
                <div x-show="open" class="w-36 border border-gray-400 bg-gray-200 absolute top-18 right-0 z-10">
                    <ul class="w-full text-sm space-y-2">
                        <li><a class="p-2 block hover:bg-gray-300" href="/profile">Edit Profile</a></li>
                        @if (Auth::user()->name == 'admin')
                            <li><a class="p-2 block hover:bg-gray-300" href="/admin/category/create">Create Category</a>
                            </li>
                            <li><a class="p-2 block hover:bg-gray-300" href="/admin/posts/create">Create Post</a></li>
                        @endif
                        <li><a class="p-2 block hover:bg-gray-300" href="/logout">Logout</a></li>
                    </ul>
                </div>
            </div>
        </div>
