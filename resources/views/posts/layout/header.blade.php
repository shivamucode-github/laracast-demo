    ...
    <header class="py-6 flex gap-12 items-center justify-between border-b border-gray-500">
        ...
        <div class="flex items-center gap-6">
            ...
            <div class="relative" x-data="{ open: false }">
                ...
                <div x-show="open" class="w-36 border border-gray-400 bg-gray-200 absolute top-18 right-0">
